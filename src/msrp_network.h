...
extern pthread_t recv_thread;		/* The receiving thread */
extern pthread_mutex_t recv_lock;	/* A lock to access the file descriptors */
extern fd_set recv_fds;		/* File descriptors set for reading */
extern int recv_fdmax;			/* Highest file descriptor */
extern int recv_pair[2];		/* A socket pair to unblock select, when needed */
