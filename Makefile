...
msrp.o msrp_callback.o msrp_message.o msrp_network.o msrp_relay.o msrp_session.o msrp_switch.o msrp_utils.o endpointmsrp.o globals.o
...
msrp.o msrp_callback.c msrp.message.c msrp_network.c msrp_relay.c msrp_session.c msrp_switch.c msrp_utils.c endpointmsrp.c globals.c
